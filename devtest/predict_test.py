...
# Velike slike
im = np.load('/home/dkrst/DATA/YOLO_sets1920x1024/TEST/join_st/000003_s_000296.npz')['im']
im.shape

results = model.predict([im], imgsz=(1024,1920))
...
for r in results:
    ...
    for b in boxes:
        ...
        cv2.rectangle(frame, r[:2], r[2:], (0,0,255))
